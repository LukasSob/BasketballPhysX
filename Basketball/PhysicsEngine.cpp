...
namespace PhysicsEngine
{
	...
	void DynamicActor::SetGlobalPose(const PxTransform& pose)
	{
		((PxRigidBody*)actor)->setGlobalPose(pose);
		
	}


	void DynamicActor::ResetShapeVel() {
		((PxRigidBody*)actor)->setAngularVelocity(PxVec3(0.0f, 0.0f, 0.0f));
		((PxRigidBody*)actor)->setLinearVelocity(PxVec3(0.0f, 0.0f, 0.0f));
	}

	void DynamicActor::DisableGravity(bool value) {
		((PxActor*)actor)->setActorFlag(PxActorFlag::eDISABLE_GRAVITY, value);
	};
	...
	void DynamicActor::LockAxis(bool value, PxU32 index) {
		((PxRigidDynamic*)actor)->setRigidDynamicLockFlags(PxRigidDynamicLockFlag::eLOCK_ANGULAR_X | PxRigidDynamicLockFlag::eLOCK_ANGULAR_Y | PxRigidDynamicLockFlag::eLOCK_ANGULAR_Z);
	};
	...
	void StaticActor::SetGlobalPose(const PxTransform& pose)
	{
		((PxRigidBody*)actor)->setGlobalPose(pose);
